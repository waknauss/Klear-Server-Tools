...
class GenerateApacheVhost extends Command {
	protected $signature = 'webserver:generateapachevhost {username? : System Username}';
	protected $description = 'Generate Apache2 Vhost file';
	...
	public function handle() {
        ...
        $templatePath = 'templates'.DIRECTORY_SEPARATOR.'apachevhost.txt';
        ...
        $this->comment('Wrote VHost file: ['.$path.']');
        ...
        //get the command
        $commands[] = $config->get('commands.services.apache2.enable-vhost');
        $commands[] = $config->get('commands.services.apache2.stop');
        $commands[] = $config->get('commands.services.apache2.start');
